## **Q: How do I get the beta version of Music Amplifier?**
You can opt-in for the beta build by clicking on this link: https://play.google.com/apps/testing/com.mp3.player.retromusic

___

## **Q: How to restore my purchases?**
Make sure to switch and use your account in the Play Store app through which you purchased before installing Music Amplifier. The Google account used to install the app is also used to purchase/restore the pro license.
...
There are three methods for adding offline synced lyrics in Music Amplifier.
...
#### STEP 3: 
Open Music Amplifier and head to the song synced lyrics editor.
#### STEP 4: 
...
- The Music Amplifier in-built equalizer was removed updates ago so the only equalizer you will have by your OEM or Android native equalizer which isn't made by us and have no control over them. So you can report those issues to your OEM so that they can provide a fix in the next updates.
...
Settings -> Personalize -> Fullscreen controls -> Enable (this will only be visible when songs are playing from Music Amplifier).
___
...
Music Amplifier uses the native media player that comes with your Android phone, so as long as a file type is supported by your phone, it's supported by Music Amplifier.
___

## **Q: Why is my device slowing down when I'm using the app?**
Music Amplifier is image intensive, it keeps images in the cache for quick loading.
___

## **Q: The title "Music Amplifier" is showing on the top of the app, how can I fix this?** 
...
1. Then open the Music Amplifier app and manually scan your music from your storage. 

1. Reboot the device to refresh the media store (Not sure if this is necessary)

**NOTE:** Don't panic when you will open Music Amplifier and see "Zero" songs there in the library. It's because you cleared Media Store which is responsible for recognising files on your device.
___
...
- Music Amplifier's font has now been replaced with system font, which means the default font your system uses will be used by Music Amplifier too. It fixes all font-related issues you used to face/are facing in the app. 

- With the recent Music Amplifier v5 release, we have a built-in optional font "Manrope font" which you can toggle from Settings > Look & Feel > Toggle "Use manrope font".
...
In your built-in music player, there should be an option to save that playlist as a file. Save them and import them from the file manager by opening it into Music Amplifier.

> Note that such playlist must be of your offline music only since Music Amplifier is an offline music player, not an online music player. So if your playlist is of online music, it can't be opened on other offline players nor can be exported
___

## **Q: How to restore/import playlist?**
Music Amplifier will automatically detect any playlist file when that playlist file is stored in internal storage/Playlist. However, if it doesn't, just open any "File manager" and open that playlist file with Music Amplifier.

 ...
 *
 */
package com.mp3.player.retromusic.activities.bugreport
...
import com.mp3.player.retromusic.activities.bugreport.model.DeviceInfo
import com.mp3.player.retromusic.databinding.ActivityBugReportBinding
...
open class BugReportActivity : AbsThemeActivity() {
    ...
    companion object {
        private const val ISSUE_TRACKER_LINK =
            "https://github.com/vietnux/RetroMusicPlayer/issues"
    }
}

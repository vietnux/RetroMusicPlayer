 ...
 *
 */
package com.mp3.player.retromusic.fragments.about
...
import com.mp3.player.retromusic.Constants
import com.mp3.player.retromusic.R
import com.mp3.player.retromusic.adapter.ContributorAdapter
import com.mp3.player.retromusic.ads.AdmobLib
import com.mp3.player.retromusic.databinding.FragmentAboutBinding
import com.mp3.player.retromusic.extensions.openUrl
...
//        binding.aboutContent.cardSocial.websiteLink.setOnClickListener(this)
        ...
        binding.aboutContent.cardRetroInfo.appGithub.setVisibility(View.GONE)
        binding.aboutContent.cardRetroInfo.faqLink.setVisibility(View.GONE)
        binding.aboutContent.cardRetroInfo.appTranslation.setVisibility(View.GONE)
        binding.aboutContent.cardRetroInfo.donateLink.setVisibility(View.GONE)
    }
